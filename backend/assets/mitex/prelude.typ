// Vendored from the MiTeX Typst package (https://github.com/mitex-rs/mitex),
// Apache License 2.0. Copyright (c) Myriad-Dreamin, OrangeX4, Enter-tainer.
// Used as the evaluation scope for LaTeX-to-Typst math conversion; the only
// change is that the `xarrow` package import is replaced by an offline stub.
